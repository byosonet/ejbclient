package ClientEjbXmlByte;

import com.prototype.ejb.xml.bytes.ProcesarXmlByteBean;
import com.prototype.ejb.xml.bytes.ProcesarXmlByteRemote;
 ...
 * @author ulysses.mac
 */
public class ClientEjbXmlBytes {
    public void ClienteEJB(String modo, boolean encode) throws NamingException, ParseoException, IOException {
        ...
        byte[] archivo = null;
        try {
            File fileTimbrado = new File("C:\\Users\\User\\Documents\\NetBeansProjects\\EJBClient\\src\\ClientEjbXmlByte\\CFDI_COD.xml");
            String xmlTimbrado = new String(Files.readAllBytes(Paths.get(fileTimbrado.toString())));
            
            File filePago = new File("C:\\Users\\User\\Documents\\NetBeansProjects\\EJBClient\\src\\ClientEjbXmlByte\\PAGO_COD.xml");
            ...
            /*File fichero = new File("C:\\Users\\User\\Documents\\NetBeansProjects\\EJBClient\\src\\ClientEjbXmlByte\\PRUEBA_IMSS.PDF");
    ...
    public static void main(String args[]){
        try {
            String modo = "REMOTO";
            boolean retornoBase64 = true;
            ClientEjbXmlBytes cte = new ClientEjbXmlBytes();
